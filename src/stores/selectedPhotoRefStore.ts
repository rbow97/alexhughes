...
export const currentAlbum = atom<{albumLength: number | undefined, centralPhotoInAlbumIndex: number | undefined, albumName: string | undefined}>({albumLength: undefined, centralPhotoInAlbumIndex: undefined, albumName: undefined })
