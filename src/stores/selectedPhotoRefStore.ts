...
export const currentAlbum = atom<{albumLength: number | undefined, centralPhotoInAlbumIndex: number | undefined}>({albumLength: undefined, centralPhotoInAlbumIndex: undefined })
